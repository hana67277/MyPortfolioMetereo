...
const projects = [
  {
    id: 1,
    title: "Deploying a website using Vercel",
    description: "A beautiful website using Vercel tool and JavaScript.",
  ...
  },
  {
    ...
    description: "Made an AI Chatbot using Python in VS Code.",
