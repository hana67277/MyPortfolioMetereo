    ...
    <div className="container max-w-4xl mx-auto text-center z-10" >
        <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-2-2xl max-auto opacity-0 animate-fade-in-delay-3">
                I specializes in building modern, responsive, and user-friendly websites.
                Designing interfaces that are both beautiful and functional. 
                Always learning and exploring new technologies to turn ideas into reality.
            </p>
